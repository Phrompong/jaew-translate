...
const SolutionModal: React.FC<ModalProps> = ({ onClick }) => {
  return (
    <>
      <div className="fixed z-10 pt-24 w-full h-full overflow-auto bg-black bg-opacity-40 text-white md:hidden lg:flex">
      ...
      <div className="fixed z-10 pt-24 w-full h-full overflow-auto bg-black bg-opacity-40 text-white md:flex lg:hidden">
        <div className="relative top-[20%]">
          <div className="flex justify-center">
            <div className="flex flex-col border w-[90%] p-10 rounded-lg bg-modal gap-10">
              <div className="ml-[45%]">
                <div className="flex flex-row justify-between">
                  <span className="text-lg">วิธีใช้งาน</span>
                  <span>
